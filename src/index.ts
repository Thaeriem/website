...
function init() {
    ...
    const pixel_tex = pixelTex( texLoader.load(gltfModelURL));

    {
        const gltfLoader = new GLTFLoader()
        let islandMaterial = new THREE.MeshPhongMaterial( {
            specular: 0x123456,
            shininess: 0
        })
        gltfLoader.load(gltfModelURL, (gltf) => {
            ...
            gltfModel.traverse((child) => {
                ...
                child.material = islandMaterial; // Apply the material to the mesh
              }
